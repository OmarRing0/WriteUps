...
![Python keygen generating the code 1724 for the name omar](images/05-welcome-ascii.png)

*Python keygen generating the code 1724 for the name "omar".*

![Successful run showing the WELCOME ASCII art](images/02-generate-password-func.png)
